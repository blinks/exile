...
=== Advance seven action dice
Advance your seven actions (d4 to d6, d6 to d8) like this:
...
- Advance three more actions anywhere you please (max rating is 2, remember).

=== Pack for the trip
Write down three things you brought from home. Each grants two dice.

- Choose a family heirloom that you feel reflects your character's heritage.
- Choose a useful tool that you feel reflects your character's background.
- Choose a bit of colonist gear that was assigned to you.

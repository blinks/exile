...
default. If Bird goes off and finds the raptormech hangar, and Whip gave them
her way into the ship, only Bird and Whip know about it. Either of them can
...
To succeed at something in Exile, you roll six-sided dice and look for the
highest number. The higher it is, the better you did. Then you look for the
lowest number: the entropy dice. This stresses out what you used to roll the
dice.

Humans are tool-makers. The dice you roll came from your tools, resources,
knowledge, and friends, and the more they must do, the more stressed out they
get. You can always count on yourself for a die (if you want). You probably
have something on your character sheet that could give you a die, too. All of
these things have a clock associated with them. (See
https://bladesinthedark.com/progress-clocks for some background.)

When you use something for dice, it's included in the stuff that takes stress
from that roll. The entropy dice determine how much stress is taken: the value
plus one for each additional die that rolled that value.

That is, if I used myself and my "way into the ship" resource to look for some
medical gear, I'd roll two dice. If I roll two 6s, I was super-successful at a
massive (7-stress) cost, taking 3 stress to myself and 4 to my way in, or
vice-versa. If I roll a 6 and a 1, I was successful at minimal (1-stress) cost,
taking 1 stress to _either_ myself or my way in..

Each clock has a number of ticks before it breaks. If you break (as a
character), you're out of play. This could mean death, or that you're severely
wounded, or that you just can't go on. Roll up a new character. If one of your
tools breaks, well that's pretty straightforward, isn't it? If my way into the
ship "broke," that probably means there was a tunnel collapse, or perhaps some
new fires broke out, or the radiation has gotten too bad to go that way.
...
- A name for the ship and the colony.
- A pyramid of locations (1 on 2 on 3 on 4 on 5) for writing. On the top, write
  "the ship" / "the colony" / "planetfall".
- A list of things that existed on the colony ship, for exploration.
- The types of plan, as listed in "Best laid plans"
...
- A name for the playbook, a name for the planet itself and the specific region
  you landed in.
- A pyramid of food chain entries (1 on 2 on 3 on 4 on 5) for writing.
- A list of things that exist in the biome in question; you could take these
  from any Dungeon Starter.
- Gaia's threats, as described below.

Gaia gets to make plans-as-threats, but must announce them early and always
gets last initiative. [Think of Gaia's plans like the Grind in Torchbearer
applied as Conditions w/resistance from Blades in the Dark.]

By default, Gaia always has a list of basic threats (taken from Apocalypse
World):
...
Each playbook can provide some additional ideas towards these threats, but Gaia
should always announce them to the council before applying them.

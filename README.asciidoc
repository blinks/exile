...
Ten thousand colonists left Earth. Probes have been orbiting their destination
for decades mapping the surface, just like every other colony.  The colony ship
dropped in to orbit the planet safely while supplies and people were dropped
off, but something happened to it and now you’re here a little early.
...
- Advance two different actions that you feel reflect your character's heritage.
- Choose a 2d family heirloom that you feel reflects your character's heritage.
- Write down something your family believes about people, and how it affects your behavior.
...
- Advance two different actions that you feel reflect your character's background.
- Choose a useful 2d tool that you feel reflects your character's background.
- Write down something your profession believes about work, and how it affects your behavior.

=== Choose your colonist effects
Might be best to do this in a planetfall "session zero" for initial characters.

- Advance three more actions anywhere you please (max rating is d8, remember).
- Choose a bit of 2d colonist gear that was assigned to you.
- Write down something you experienced at planetfall, and how it changed your behavior.
